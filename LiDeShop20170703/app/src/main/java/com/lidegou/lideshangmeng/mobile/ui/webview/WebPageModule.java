package com.lidegou.lideshangmeng.mobile.ui.webview;
...
public class WebPageModule extends ExternalActivity {
    ...
    private void bindSomething() {
        ...
        addHtml5EventListener(new Html5EventListener("getUserID") {
            @Override
    ...
    private void defaultHandleHtml5AccessRequest(final UZModuleContext moduleContext) {
        ...
        if (name.equals("getUserID")) {
            ...
            moduleContext.success(jsonOb, true);
        }
        if (name.equals("apicloud")) {
            if (extra.toString().equals("closeAPICloud")) {
                finish();
            }
        }
        if (name.equals("gotoAddCard")) {
            startActivity(new Intent(this, CardInformationActivity.class));
        }
        if (name.equals("gotoZhangdan")) {
            if (extra.toString().equals("zhanghuguanli")) {
                startActivity(new Intent(this, AccountDetailsActivity.class));
            }
        }
        if (name.equals("gotoChongzhi")) {
            Intent xjk = new Intent(this, RechargeActivity.class);
            xjk.putExtra("type", extra.toString());
            startActivity(xjk);
        }
