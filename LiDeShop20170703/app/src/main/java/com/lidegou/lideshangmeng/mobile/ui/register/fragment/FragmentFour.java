...
import com.lidegou.lideshangmeng.mobile.ui.register.adapter.MallAreaAdapter;
...
public class FragmentFour extends BaseFragment implements MallStoreStreetContract.City, MallAreaAdapter.OnClickLisener {

    private ListView lvArea;
    private Button btnConfirm;
    private LoadingDialog loadingDialog;
    private MallStoreStreetContract.Presenter presenter;
    private MallAreaAdapter mallAreaAdapter;
    int region_idcity;
    ...
    public void callbackCountySuccess(List<County> countyList) {
        mallAreaAdapter = new MallAreaAdapter(getContext(), countyList);
        lvArea.setAdapter(mallAreaAdapter);
        mallAreaAdapter.setOnClickLisener(this);
