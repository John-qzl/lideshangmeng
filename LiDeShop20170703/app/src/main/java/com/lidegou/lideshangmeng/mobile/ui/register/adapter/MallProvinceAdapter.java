package com.lidegou.lideshangmeng.mobile.ui.register.adapter;
...
public class MallProvinceAdapter extends BaseAdapter{

    private Context context;
    private List<Province> provinceList;
    private OnClickLisener onClickLisener;
    public MallProvinceAdapter(Context context, List<Province> provinceList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_register_text, null);
