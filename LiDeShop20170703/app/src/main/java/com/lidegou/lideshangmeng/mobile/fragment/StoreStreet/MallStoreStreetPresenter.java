...
public class MallStoreStreetPresenter implements MallStoreStreetContract.Presenter {
    private MallStoreStreetContract.View view;
    private MallStoreStreetContract.ShopsClassify shopsClassifyView;
    private MallStoreStreetContract.City cityView;
    ...
    public MallStoreStreetPresenter(MallStoreStreetContract.View view) {
        this.view = view;
        this.iHomeDao = new IHomeDaoImpl();
        this.iCommodityDao = new ICommodityDaoImpl();
    }

    public MallStoreStreetPresenter(MallStoreStreetContract.ShopsClassify shopsClassifyView) {
        this.shopsClassifyView = shopsClassifyView;
        this.iCommodityDao = new ICommodityDaoImpl();
    }


    public MallStoreStreetPresenter(MallStoreStreetContract.City cityView) {
