...
import com.lidegou.lideshangmeng.mobile.adapter.JDViewAdapter;
...
public class JDAdverView extends LinearLayout {
    ...
    /**
     * 初始化属性 * @param context * @param attrs * @param defStyleAttr
     */
    ...
    /**
     * 测量控件的宽高 * * @param widthMeasureSpec * @param heightMeasureSpec
     */
    @Override
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("瑞士维氏军刀", TEXTSIZE, getHeight() * 2 / 3, mPaint);
        //写文字2/3的高度
        //** * 垂直滚蛋 */
    }

    private void performSwitch() {//属性动画控制控件滚动，y轴方向移动 Object
        Animator animator1 = ObjectAnimator.ofFloat(mFirstView, "translationY", mFirstView.getTranslationY() - mAdverHeight);
