package com.lidegou.lideshangmeng.mobile.pay.tonly;
...
//    private static String amount;
    ...
    public static JSONObject randomPaa(OtherPayEntity.PaaCreatorEntity entity) {
        String amount = (int) (Double.parseDouble(entity.getOrderAmount()) * 100) + "";
        ...
        try {
            ...
            paaParams.put("receiveUrl", entity.getReceiveUrl());
            paaParams.put("version", "v1.0");
            paaParams.put("signType", "0");
            paaParams.put("merchantId", entity.getMerchantId());
            paaParams.put("orderNo", entity.getOrderNo());
            paaParams.put("orderAmount", amount);
            paaParams.put("orderCurrency", "0");
            paaParams.put("orderDatetime", timeStr);
            paaParams.put("productName", entity.getProductName());
//			paaParams.put("ext1", ext1FromInput());
            paaParams.put("ext1", "<USER>" + entity.getExt1() + "</USER>");
...
//            paaParams.put("cardNo", "");
        ...
        String[] paaParamsArray = {
                "1", "inputCharset",
                entity.getReceiveUrl(), "receiveUrl",
                "v1.0", "version",
//				"3","language",
                "0", "signType",
                entity.getMerchantId(), "merchantId",
                entity.getOrderNo(), "orderNo",
                amount, "orderAmount",
                "0", "orderCurrency",
                timeStr, "orderDatetime",
                entity.getProductName(), "productName",
//				ext1FromInput(),"ext1",
                "<USER>" + entity.getExt1() + "</USER>", "ext1",
                "33", "payType",
//				"visa","issuerId",
//				"GOODS","tradeNature",
                "1234567890", "key",
